...
pub enum GovernanceError {
    ...
    DelegationCycle,
    /// The salt provided by the voter does not match the proposal's stored salt.
    ///
    /// This rejects off-chain signatures whose salt was computed for a
    /// different proposal instance (vote-replay prevention).
    SaltMismatch,
}
