...
impl OraclesContract {
    ...
    pub fn get_price(env: Env, oracle: Address, feed_id: String) -> Result<i128, Error> {
        ...
        let result: Result<Result<i128, _>, Result<soroban_sdk::Error, soroban_sdk::InvokeError>> =
            env.try_invoke_contract::<i128, soroban_sdk::Error>(&oracle, &soroban_sdk::symbol_short!("get_price"), soroban_sdk::vec![&env, feed_id.into()]);
    ...
    pub fn get_price_data(
        ...
        let result: Result<Result<OraclePriceData, _>, Result<soroban_sdk::Error, soroban_sdk::InvokeError>> =
            env.try_invoke_contract::<OraclePriceData, soroban_sdk::Error>(&oracle, &soroban_sdk::symbol_short!("get_pdata"), soroban_sdk::vec![&env, feed_id.clone().into()]);
        ...
        let price_result: Result<Result<i128, _>, Result<soroban_sdk::Error, soroban_sdk::InvokeError>> =
            env.try_invoke_contract::<i128, soroban_sdk::Error>(&oracle, &soroban_sdk::symbol_short!("get_price"), soroban_sdk::vec![&env, feed_id.into()]);
    ...
    pub fn is_oracle_healthy(env: Env, oracle: Address) -> Result<bool, Error> {
        ...
        let healthy: Result<Result<bool, _>, Result<soroban_sdk::Error, soroban_sdk::InvokeError>> =
            env.try_invoke_contract::<bool, soroban_sdk::Error>(&oracle, &soroban_sdk::symbol_short!("is_live"), soroban_sdk::vec![&env]);
